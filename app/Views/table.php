    ...
    <section class="table-container" aria-label="Mahasiswa data table section">
      <div class="table-header">
        <div class="title-block">
          <div class="title-text">Table Data Mahasiswa</div>
          <div class="subtitle-text">Data pembayaran pelepasan dan wisuda Mahasiswa</div>
        </div>
        <div class="actions">
        ...
        <table class="data-table" role="grid" aria-describedby="table-desc">
          ...
          <thead>
            <tr>
              ...
              <th scope="col" title="Tempat, Tanggal, Lahir column sorting" aria-sort="none" tabindex="0">
                Tempat, Tanggal, Lahir <span class="sort-indicator">▲</span>
              </th>
              <th scope="col" title="Program Studi column sorting" aria-sort="none" tabindex="0">
                Program Studi <span class="sort-indicator">▲</span>
              </th>
              <th scope="col" title="Status column sorting" aria-sort="none" tabindex="0">
                Tanggal Bayar <span class="sort-indicator">▲</span>
              </th>
              <th scope="col" title="Actions column sorting" aria-sort="none" tabindex="0">
                Bukti Pembayaran <span class="sort-indicator">▲</span>
              </th>
              <th scope="col" title="Pembayaran Pelepasan column sorting" aria-sort="none" tabindex="0">
                Pembayaran Pelepasan <span class="sort-indicator">▲</span>
              </th>
              <th scope="col" title="Pembayaran Wisuda column sorting" aria-sort="none" tabindex="0">
                Pembayaran Wisuda <span class="sort-indicator">▲</span>
              </th>
              <th scope="col" title="Status column sorting" aria-sort="none" tabindex="0">
          ...
          <tbody>
            ...
            foreach ($data as $row):
              ...
              <tr>
                ...
                <td><?= $row['bukti_pembayaran_url'] ?></td>
                <td><span class="badge active" aria-label="Status Active">Active</span></td>
                <td><span class="badge active" aria-label="Status Active">Active</span></td>
                <td><span class="badge active" aria-label="Status Active">Active</span></td>
              </tr>
              <?php
